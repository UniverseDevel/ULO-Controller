...
namespace ULOController
{
    static class Controller
    {
        ...
        static void usage()
        {
            ...
            Console.WriteLine(@"       Arguments:");
            Console.WriteLine(@"           1. destination type - " + ULO.DestinationType.Local + @", " + ULO.DestinationType.NTFS + @", " + ULO.DestinationType.FTP);
            ...
            Console.WriteLine(@"               b) " + ULO.DestinationType.NTFS + @" - ""\\<host>\<path>"" (Required: username, password)");
            ...
            Console.WriteLine(@"    - NTFS cannot be both used in Windows and used by script, if used so,");
